...
class StudentValidator
{
    public static function validate(Student $student)
    {
        ...
        if (!preg_match('/^[А-Яа-яA-Za-z]{1,50}$/u', $surname)) {
            $errors['surname'] = 'Фамилия должно иметь длину от 1 до 50 символов и состоять из букв русского или английского алфавита';
        }

        if (!preg_match('/^[А-Яа-яA-Za-z]{1,20}$/u', $group_number)) {
